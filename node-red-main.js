// ++++++++++++++++++++++++++++++ SETUP START ++++++++++++++++++++++++++++++
host="pgaw.hoggitworld.com";
port="42674";
servername="pgaw";
connectionstring="XtraLib.Stream.0\nTacview.RealTimeTelemetry.0\nnodered_webgci\n0\0";
delay=1000; //delay in milliseconds
timer=0; //Start at zero
// ++++++++++++++++++++++++++++++ SETUP END ++++++++++++++++++++++++++++++
...
function addOldTimestamp(msg) {
    const { name: name, lat: lat, lon: lon, LastSeen: LastSeen, altitude: altitude } = msg;
...
var net = context.global.get('net');
